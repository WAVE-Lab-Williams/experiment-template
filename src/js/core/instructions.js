...
function closingText(participantType) {
    var base =
        'Thank you so much for your contribution to science! The experiment has concluded. Please contact kimberly.wong@yale.edu if you have any further questions.';
    var addition = '';
